/** 
    @file magic.h
    @author dbsturgi
    Magic numbers and constants used in the DES/TDES algorithm.
*/
...
/** This is all of the permutation applied at the end of the
    ...
    P. */
extern int fFunctionPerm[ HALF_BLOCK_BITS ];
